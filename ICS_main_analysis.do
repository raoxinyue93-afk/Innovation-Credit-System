...
* width(6000) ~ 1000 DPI at a typical 6-inch print width (line drawing,
* per journal guide: line drawings require a minimum of 1000 dpi)
graph export "/Users/raoxinyue/Documents/stata-project3/output/figures/Figure1_CS_event_study_BW.png", replace width(6000)
restore
...
* width(6000) ~ 1000 DPI at a typical 6-inch print width (line drawing)
graph export "/Users/raoxinyue/Documents/stata-project3/output/figures/Figure2_placebo_test_plot.png", replace width(6000)
